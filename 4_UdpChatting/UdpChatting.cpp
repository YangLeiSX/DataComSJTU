...
int main(int argc, char* argv[]) {
    ...
    if (argc == 1) {
        ...
        printf("Usage:");
        printf("\tHolder: %s", argv[0]);
        printf("\tTalker: %s <holder-ip>", argv[0]);
        exit(EXIT_FAILURE);
    }
    ...
    if (isHolder)
        ...
        iResult = getaddrinfo(hostname, TALK_PORT, &hints, &result);
